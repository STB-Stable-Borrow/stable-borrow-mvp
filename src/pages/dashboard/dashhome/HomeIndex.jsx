...
function HomeIndex({totalLck, totalDebt, xdcPrc, hauntedVlts, liquidatedVlts, colRatio}) {
  ...
  console.log(totalLck,"...lck",hauntedVlts,"..../haunt")
  ...
  return (
    <div className=" overflow-hidden ">
      <div className=" text-[#D9D9D9] flex justify-around mb-[5.09vh]   ">
        <div className={`${!isBorrowOverview && "opacity-10 cursor-not-allowed"} border-[2px] border-dashed border-[#585858] px-[1.04vw]   h-[34.26vh] rounded-[40px] py-[1.94vh] bg-gradient-to-b 180deg from-[#009fbd] -52.27 to-[#344e53] 127.2% flex flex-col gap-[2.78vh] items-center `}>
          ...
          <button className={`${!isBorrowOverview && "cursor-not-allowed"} bg-[#009FBD] w-[12.66vw] py-[0.85vh] rounded-lg flex items-center justify-center gap-2 text-[0.85rem] text-white hover:bg-opacity-75`}>
            Borrow Now{" "}
            <img src={arrow} alt="" className="w-[2.22vh] h-[2.22vh] " />
          </button>
        </div>
        <div className={`${!isEarnOverview && "opacity-10 cursor-not-allowed"} border-[2px] border-dashed border-[#585858] px-[1.04vw]   h-[34.26vh] rounded-[40px] py-[1.94vh] bg-gradient-to-b 180deg from-[#865DFF] -52.27 to-[#344e53] 127.2%  flex flex-col gap-[2.78vh] items-center`}>
          ...
          <button className={`${!isEarnOverview && "cursor-not-allowed"} bg-[#865DFF] w-[12.66vw] py-[0.85vh] rounded-lg flex items-center justify-center gap-2 text-[0.85rem] text-white hover:bg-opacity-75 `}>
            Earn Now{" "}
            <img src={arrow} alt="" className="w-[2.22vh] h-[2.22vh] " />
          </button>
        </div>
