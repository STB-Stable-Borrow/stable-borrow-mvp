...
function Exchange() {
  ...
  return (
    <div className="flex items-center gap-[2.60vw] h-full w-full ">
      <div className="rounded-[40px] bg-[#202225] h-full px-[1.30vw] py-[1.67vh] flex flex-col items-center justify-between w-[40.5vw] mx-auto ">
        <div className="flex flex-col items-center">
          <h1 className="text-[#B0B0B0] text-[] font-semibold ">Stable Swap</h1>
          <img
            src={drag}
            alt=""
            className="w-[3.70vw] h-[0.56vh] mb-[0.98vh] "
          />
        </div>
