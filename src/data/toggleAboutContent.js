export const toggleAbout = [
  {
    ...
    content: `Stable Borrow(STB) works on a unique lending protocol that lends out STC to users against XDC in an over collateralized manner in order to ensure STC is stable and its price is tied to $1. 
      ...
      Why STB? 
      For the love of decentralization, money and fun; with our specifications listed above it is obvious that decentralization makes up STB and from our earn as you play GameFi protocol it’s all about money and fun.`,
  },
  {
    id: 2,
    name: "Stable Coin (STC)",
    content: `Stable Coin(STC) is STB’s native XRC 20 token built on XDC Network; it's similar to ERC 20 token on Ethereum.STC is a collateral-backed XRC 20 token it attempts to maintain a stable 1:1 value with the U.S. dollar by locking XDC as collateral through STB unique lending protocol. It maintains its value not by being backed by U.S. dollars or centralized entities, but by using collateralized debt in XDC. Locked XDC proves STC is fully backed and worthy to be tied to $1, since locking of collateral is risky due to price fluctuations of the collateral, the over collateralized mechanism ensures that STC is still overpaid for and worth more than total STC lent out, when the price of the collateral goes down and the collateralization ratio of XDC to STC is lower than appropriate, the vault containing that loan is in Liquidation and the regulatory protocol ensure this is dealt with and the locked collateral is taken in place to back STC and will be use to buy STC to ensure it's stability Why STC? List of what makes STC unique and better: 1. STC is fully decentralized without the backing of any centralized entity  2. STC is a stable token pegged to the U.S. dollars and it’s price is tied to 1$, you can exchange any token to STC on exchanges and save in STC and be free from price fluctuations  3. STC is a collateral backed stable token and it’s creation depends on locking up collateral in smart contracts  4. STC price is independent of price fluctuation of the locked collateral through STB regulatory protocol changes to collateral price will be regulated in other to keep STC stable  5. STC is available to everyone and can be owned through different methods(exchange, staking, earning e.t.c), you don’t have to borrow against XDC to own it everytime",
    `,
  },
  {
    id: 3,
  ...
  },
  {
    id: 4,
    name: "Borrow",
    content: `Borrowers are STB users that borrow STC against XDC in an over collateralized manner and
  ...
  },
  {
    id: 5,
    name: "Earn",
    content: `Haunters are STB users that regulate vaults, prices and collateralization ratio on the
    platform.
    ...
    haunt, they more you haunt the more you earn and your earnings are in XDC`,
  },
];
