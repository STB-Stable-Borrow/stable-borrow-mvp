      ...
      <body className="md:mx-[60px] md:mt-[48px] flex justify-between text-white  min-h-[calc(100vh-180px)] overflow-hidden  ">
        <div className=" flex-col flex justify-between md:w-[45%] ">
          <div className="border border-[#009FBD]  rounded-[30px] flex flex-col items-center gap-[5px] px-[6px] py-2 md:h-[48%]  ">
            ...
            <h1 className="font-black border-b-2 border-[#009FBD] text-lg ">Borrow STC</h1>
            <p className="text-center mx-4 mt-2 text-[#FFFFFF] ">
              <span className="text-lg font-bold text-white">
              Stable Coin ($STC)
              </span> is Stable Borrow (STB) Official Token, it’s a
              fully Decentralized and collateral backed token that’s maintains
              1usd as it’s price making it a Stable Token ...{" "}
              <Link to="/about" className="text-[#865DFF] underline underline-offset-2 hover:underline cursor-pointer " onClick={() => navigateToAbout("Borrow")}>
                learn more
              </Link>
            </p>
            <button className="bg-[#009FBD] hover:bg-opacity-75 rounded-lg text-lg px-[40px] py-2 mt-2">
              Borrow now
            </button>
          </div>
          <div className="border border-[#009FBD]  rounded-[30px] flex flex-col items-center gap-[5px] px-[6px] py-2 md:h-[48%]  ">
            <img src={earn} alt="" className="w-[120px] " />
            <h1 className="font-black border-b-2 border-[#009FBD] text-lg ">Earn STC</h1>
            <p className="text-center mx-4 mt-2 text-[#FFFFFF] ">
            Register as an haunter today to earn as you play by haunting
              ...
              <Link to="/about" className="text-[#865DFF] underline underline-offset-2 hover:underline " onClick={() => navigateToAbout("Earn")}>
                learn more
              </Link>
            </p>
            <button className="bg-[#009FBD] hover:bg-opacity-75 rounded-lg text-lg px-[40px] py-2 mt-2">
        ...
        <div className="border border-[#009FBD]  rounded-[30px] flex flex-col items-center gap-[10px] py-[6px] px-[20px] w-[45%] ">
          <img src={exchange} alt="" className="w-[80px] " />
          <h1 className="font-black border-b-2 border-[#009FBD] text-lg ">Exchange</h1>
          ...
          <p className="text-center mx-4 mt-2 text-[#FFFFFF] ">
            ...
            <Link to="/about" className="text-[#009FBD] hover:underline " onClick={() => navigateToAbout("Exchange")}>
              learn more
            </Link>
          </p>
          <button className="bg-[#865DFF] hover:bg-opacity-75 rounded-lg text-lg px-[40px] py-2 mt-2">
            Exchange
          </button>
        </div>
      </body>
