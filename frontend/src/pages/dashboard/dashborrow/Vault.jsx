...
function Vault() {
  return (
    <div>
      ...
      <div className="flex justify-center gap-[57px] items-center mb-[6.15vh]">
      ...
      <h1 className="w-full bg-[#202225] text-center text-[#B0B0B0] font-bold text-[1.125rem] border-[#585858] border-dashed border rounded-[7px] h-[4.5989vh] mb-[2.73vh] ">
        Vaults History
      </h1>
      ...
      <div className="table w-full h-[34.57vh] text-[#B0B0B0] text-[1rem] ">
        <div className="bg-[#202225] h-[5.76vh] flex justify-between items-center pl-[22px] border-b border-[#B0B0B0] ">
          <h1 className="w-[400px] ">Activity</h1>
          <h1 className=" w-[200px]  ">Date and Time</h1>
          <h1 className=" w-[200px]  ">Tx Hash</h1>
        </div>
        <div className="h-[28.8vh] overflow-y-auto">
          {vaultsData.map((item) => (
            <div className="bg-[#292C31] h-[5.76vh] flex justify-between items-center pl-[22px] border-b border-[#B0B0B0] ">
              <h1 className="w-[400px] ">{item.activity}</h1>
              <h1 className=" w-[200px] ">
                {item.date} | {item.time}
              </h1>
              <h1 className="w-[200px]">{item.txHash}</h1>
            </div>
          ))}
        </div>
      </div>
