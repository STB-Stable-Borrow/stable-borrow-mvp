  ...
  return (
    <div className="bg-[#292C31] rounded-[12px] flex flex-col gap-[4vh] w-[735px] py-[2vh] px-[86px] ">
      ...
      <div className="flex items-center justify-center gap-[110px] mt-[5.19vh] mb-[5.5vh] ">
        <button className="border border-[#009FBD] w-[164px] h-[7.95vh] rounded-lg flex items-center justify-center gap-2 bg-inherit hover:opacity-75 ">
          <img src={back} alt="" />
          Back
        </button>
        <button className="bg-[#009FBD] w-[210px] h-[7.95vh] rounded-lg flex items-center justify-center gap-2  hover:bg-opacity-75 ">
          Generate
          <img src={gen} alt="" />
        </button>
      </div>
